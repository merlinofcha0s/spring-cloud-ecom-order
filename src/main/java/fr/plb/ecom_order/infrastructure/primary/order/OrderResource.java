...
import fr.plb.ecom_order.application.OrderApplicationService;
...
import fr.plb.ecom_order.infrastructure.secondary.service.user.vo.UserAddressBuilder;
import fr.plb.ecom_order.infrastructure.secondary.service.user.vo.UserAddressToUpdate;
import fr.plb.ecom_order.infrastructure.secondary.service.user.vo.UserAddressToUpdateBuilder;
...
import static fr.plb.ecom_order.configuration.security.SecurityUtils.ADMIN;
  ...
  private void handleCheckoutSessionCompleted(StripeObject rawStripeObject) {
    if (rawStripeObject instanceof Session session) {
      ...
      UserAddressToUpdate userAddressToUpdate = UserAddressToUpdateBuilder.userAddressToUpdate()
        ...
        .userPublicId(new PublicId(UUID.fromString(session.getMetadata().get("user_public_id"))))
        .build();
